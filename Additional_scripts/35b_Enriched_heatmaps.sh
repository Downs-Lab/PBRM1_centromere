...
## Example script from data in publication - fig4D - enriched heatmaps showing SWI/SNF subunit enrichment across specific groups of peaks (e.g. PBRM1-specific)
...
srun Rscript Additional_scripts/35b_Enriched_heatmaps.R
