...
sed '1d' kmer_centromere/enriched_kmers/${base}_1_vs_Control_fc2.txt \
> kmer_centromere/enriched_kmers/${base}_1_vs_Control_fc2.fa.txt
sed '1d' kmer_centromere/enriched_kmers/${base}_2_vs_Control_fc2.txt \
> kmer_centromere/enriched_kmers/${base}_2_vs_Control_fc2.fa.txt
sed '1d' kmer_centromere/enriched_kmers/${base}_3_vs_Control_fc2.txt \
> kmer_centromere/enriched_kmers/${base}_3_vs_Control_fc2.fa.txt
